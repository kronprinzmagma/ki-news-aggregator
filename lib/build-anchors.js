...
*Aus dem [KI Daily vom ${date}](https://github.com/${REPO_SLUG}/issues?q=KI+Daily+${date}).*
...
export async function writeBuildAnchorIndex({ repoRoot = '.' } = {}) {
  ...
  const lines = [
    ...
    '',
    `Konkrete Abend-Projekte mit Claude Code, die aus den täglichen [KI-News-Briefings](https://github.com/${REPO_SLUG}/issues?q=is%3Aissue+%22KI+Daily%22) extrahiert wurden. Jeder Anker ist so geschnitten, dass er in 2–4 Stunden mit Claude Code umsetzbar ist – keine Wochenprojekte, keine Hardware-Setups.`,
    '',
