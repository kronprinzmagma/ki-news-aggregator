...
// Feed liefert nur Headline-Teaser → truncated-Pre-Filter blockt sie.
// Per Enrichment-Fetch Volltext direkt von deeplearning.ai holen.
export async function fetchArticles() {
  ...
  return Promise.all(articles.map(a => enrichFromUrl(a, { logTag: 'thebatch' })));
}
